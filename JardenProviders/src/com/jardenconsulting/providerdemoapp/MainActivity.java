...
import jarden.engspa.DetailUserFragment;
import jarden.engspa.MasterFragment;
import jarden.engspa.MasterUserFragment;
...
public class MainActivity extends FragmentActivity {
	...
	public void setUserUri(Uri userUri) {
		if (this.detailUserFragment == null) {
			detailUserFragment = new DetailUserFragment();
		}
		detailUserFragment.setUserUri(this, userUri);
		setFragment(detailUserFragment, true);
	}
